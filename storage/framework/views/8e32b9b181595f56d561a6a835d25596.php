<div class="py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Stats Card -->
        <div
            class="bg-base-100 dark:bg-dark-base-100 rounded-lg shadow-md p-4 border-l-4 border-primary mb-8 inline-block">
            <div class="flex items-center gap-3">
                <svg class="w-8 h-8 text-primary" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M5 4a2 2 0 012-2h6a2 2 0 012 2v14l-5-2.5L5 18V4z"></path>
                </svg>
                <div>
                    <div class="text-2xl font-bold text-base-content dark:text-dark-base-content"><?php echo e($totalFavorites); ?>
                ...
                <div
                    ...
                    <a href="<?php echo e(route('inspiration.show', $inspiration->id)); ?>"
                        ...
                        <?php else: ?>
                            <div class="w-full h-full flex items-center justify-center">
                                <svg class="w-16 h-16 text-base-content/30 dark:text-dark-base-content/30"
                                  ...
                                  2 0 00-2-2H6a2 2 0 00-2 2v12a2
                                  2 0 002 2z"></path>
                                </svg>
                            </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="absolute top-2 right-2">
                            <span
                                class="px-3 py-1 bg-primary text-primary-content text-xs font-semibold rounded-full shadow-lg flex items-center gap-1">
                    ...
                    <div class="p-4">
                        ...
                        <div
                            ...
                            <button wire:click="removeFavorite(<?php echo e($inspiration->id); ?>)"
                                wire:confirm="Yakin ingin menghapus dari favorit?"
                                class="p-2 hover:bg-primary/10 rounded-lg transition-colors group/btn"
                                title="Hapus dari favorit">
                                <svg class="w-5 h-5 text-primary group-hover/btn:scale-110 transition-transform"
...
<?php /**PATH C:\Users\user\Documents\WEB_HOMESPIRE\resources\views/livewire/my-favorites.blade.php ENDPATH**/ ?>