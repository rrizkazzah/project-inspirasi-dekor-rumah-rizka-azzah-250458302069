...
<div x-data="{ shown: false, timeout: null }"
     ...
     style="display: none;"
    <?php echo e($attributes->merge(['class' => 'text-sm text-gray-600 dark:text-gray-400'])); ?>>
    <?php echo e($slot->isEmpty() ? __('Saved.') : $slot); ?>

</div>
<?php /**PATH C:\Users\user\Documents\WEB_HOMESPIRE\resources\views/components/action-message.blade.php ENDPATH**/ ?>