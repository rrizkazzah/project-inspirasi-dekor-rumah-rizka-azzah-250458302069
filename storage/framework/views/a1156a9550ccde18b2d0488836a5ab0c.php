...
<div class="grid gap-3 p-4 bg-neutral-50 dark:bg-transparent overflow-x-auto rounded-lg">
    <!--[if BLOCK]><![endif]--><?php if($frame->previous()): ?>
        <div class="flex">
...
<?php /**PATH C:\Users\user\Documents\WEB_HOMESPIRE\vendor\laravel\framework\src\Illuminate\Foundation\Providers/../resources/exceptions/renderer/components/vendor-frame.blade.php ENDPATH**/ ?>