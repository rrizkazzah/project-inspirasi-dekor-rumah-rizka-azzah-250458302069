    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $inspirations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inspiration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div
                    class="group relative bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-span-full text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">Tidak ada inspirasi ditemukan
                    </h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        <!--[if BLOCK]><![endif]--><?php if($search || $ruanganFilter || $tagFilter): ?>
                            Coba ubah filter atau kata kunci pencarian Anda.
                        <?php else: ?>
                            Belum ada inspirasi yang disetujui. Inspirasi yang baru di-upload sedang dalam proses
                            moderasi.
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </p>
...
<?php /**PATH C:\Users\user\Documents\WEB_HOMESPIRE\resources\views/livewire/inspiration-gallery.blade.php ENDPATH**/ ?>