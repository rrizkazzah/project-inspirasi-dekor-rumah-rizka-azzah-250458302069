...
<head>
    ...
    <title>{{ config('app.name', 'Homespire') }} - {{ $title ?? 'Platform Inspirasi Desain' }}</title>
        ...
        <div class="container-auto">
                    ...
                    @auth
                        <div x-data="{ isOpen: false }" class="relative" @click.away="isOpen = false">
                            ...
                            <div x-show="isOpen" 
                                ...
                                <a href="{{ route('my.uploads') }}" class="block px-4 py-2 text-sm text-base-content hover:bg-base-200">Unggahan Saya</a>
                                <a href="{{ route('my.likes') }}" class="block px-4 py-2 text-sm text-base-content hover:bg-base-200">
                                ...
                                <a href="{{ route('my.favorites') }}" class="block px-4 py-2 text-sm text-base-content hover:bg-base-200">
                                    <span class="flex items-center gap-2">
            ...
            <div x-show="isNavOpen" 
                ...
                <ul class="flex flex-col space-y-2 mt-4">
                    <li><a href="{{ route('home') }}" class="block px-4 py-2 rounded-md hover:bg-base-200 {{ request()->routeIs('home') ? 'bg-base-200 text-primary' : '' }}">Home</a></li>
                    <li><a href="{{ route('gallery') }}" class="block px-4 py-2 rounded-md hover:bg-base-200 {{ request()->routeIs('gallery') ? 'bg-base-200 text-primary' : '' }}">Galeri Inspirasi</a></li>
                    <li><a href="{{ route('inspiration.upload') }}" class="block px-4 py-2 rounded-md hover:bg-base-200 {{ request()->routeIs('inspiration.upload') ? 'bg-base-200 text-primary' : '' }}">Unggah Inspirasi</a></li>
                    <li><a href="{{ route('articles.index') }}" class="block px-4 py-2 rounded-md hover:bg-base-200 {{ request()->routeIs('articles.*') ? 'bg-base-200 text-primary' : '' }}">Artikel</a></li>
                    <li><a href="{{ route('testimonials') }}" class="block px-4 py-2 rounded-md hover:bg-base-200 {{ request()->routeIs('testimonials') ? 'bg-base-200 text-primary' : '' }}">Testimoni</a></li>
                    <li><a href="{{ route('faq') }}" class="block px-4 py-2 rounded-md hover:bg-base-200 {{ request()->routeIs('faq') ? 'bg-base-200 text-primary' : '' }}">FAQ</a></li>
                    
                    @auth
                        <li class="pt-2 mt-2 border-t border-base-300">
                            <div class="px-4 py-2 text-sm font-medium text-base-content/60">{{ Auth::user()->name }}</div>
                        </li>
                        <li><a href="{{ route('profile') }}" class="block px-4 py-2 rounded-md hover:bg-base-200 {{ request()->routeIs('profile') ? 'bg-base-200 text-primary' : '' }}">Profil</a></li>
                        <li><a href="{{ route('my.uploads') }}" class="block px-4 py-2 rounded-md hover:bg-base-200 {{ request()->routeIs('my.uploads') ? 'bg-base-200 text-primary' : '' }}">Unggahan Saya</a></li>
                        <li>
                            <a href="{{ route('my.likes') }}" class="block px-4 py-2 rounded-md hover:bg-base-200 {{ request()->routeIs('my.likes') ? 'bg-base-200 text-primary' : '' }}">
                                <span class="flex items-center gap-2">
                                    <svg class="w-4 h-4 text-error" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clip-rule="evenodd"></path>
                                    </svg>
                        ...
                        <li>
                            <a href="{{ route('my.favorites') }}" class="block px-4 py-2 rounded-md hover:bg-base-200 {{ request()->routeIs('my.favorites') ? 'bg-base-200 text-primary' : '' }}">
                                <span class="flex items-center gap-2">
                                    <svg class="w-4 h-4 text-primary" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M5 4a2 2 0 012-2h6a2 2 0 012 2v14l-5-2.5L5 18V4z"></path>
                                    </svg>
                        ...
                        @if(Auth::user()->isAdmin())
                            <li><a href="{{ route('admin.dashboard') }}" class="block px-4 py-2 rounded-md hover:bg-base-200">Dashboard Admin</a></li>
                        @endif
                        <li>
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                    ...
                    @else
                        <li class="pt-2 mt-2 border-t border-base-300">
                            <a href="{{ route('login') }}" class="block px-4 py-2 rounded-md hover:bg-base-200">Login</a>
                        </li>
                        <li>
                            <a href="{{ route('register') }}" class="block px-4 py-2 rounded-md bg-primary hover:bg-primary/90 text-primary-content">Daftar</a>
                        </li>
                    @endauth
                </ul>
            </div>
