        ...
        <div class="bg-base-100 dark:bg-dark-base-100 rounded-lg shadow-lg p-6">
            ...
            <div class="alert alert-info mb-6">
                ...
                <div>
                    ...
                    <div class="text-sm">
                        Inspirasi yang Anda unggah akan ditinjau oleh admin terlebih dahulu sebelum muncul di galeri
                        publik.
            ...
            <form wire:submit="submit" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="image1"
                            class="flex flex-col items-center justify-center w-full h-64 border-2 border-base-300 dark:border-dark-base-300 border-dashed
        rounded-lg cursor-pointer bg-base-200/50 dark:bg-dark-base-200/50 hover:bg-base-200 dark:hover:bg-dark-base-200">

                            <!--[if BLOCK]><![endif]--><?php if($image1): ?>
                                <div class="relative w-full h-full">
                                    <img src="<?php echo e($image1->temporaryUrl()); ?>"
                                        class="w-full h-full object-cover rounded-lg">
                                </div>
                            <?php else: ?>
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    <svg class="w-12 h-12 mb-4 text-base-content/50 dark:text-dark-base-content/50"
                            ...
                            13l-3-3m0 0l-3 3m3-3v12">
                                    ...
                                    <p class="mb-2 text-sm"><span class="font-semibold">Klik untuk upload</span></p>
                                    <p class="text-xs">PNG, JPG (MAX. 5MB)</p>
                                </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                            <input wire:model="image1" id="image1" type="file" class="hidden" accept="image/*" />
                        </label>
                    </div>
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['image1'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        rounded-lg cursor-pointer bg-base-200/50 dark:bg-dark-base-200/50 hover:bg-base-200 dark:hover:bg-dark-base-200">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($image2): ?>
                                <div class="relative w-full h-full">
                                    <img src="<?php echo e($image2->temporaryUrl()); ?>"
                                        class="w-full h-full object-cover rounded-lg">
                                </div>
                            <?php else: ?>
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <input wire:model="image2" id="image2" type="file" class="hidden" accept="image/*" />
                        </label>
                    </div>
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['image2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        rounded-lg cursor-pointer bg-base-200/50 dark:bg-dark-base-200/50 hover:bg-base-200 dark:hover:bg-dark-base-200">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($image3): ?>
                                <div class="relative w-full h-full">
                                    <img src="<?php echo e($image3->temporaryUrl()); ?>"
                                        class="w-full h-full object-cover rounded-lg">
                                </div>
                            <?php else: ?>
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <input wire:model="image3" id="image3" type="file" class="hidden" accept="image/*" />
                        </label>
                    </div>
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['image3'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['ruangan_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['tags_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Informasi Tambahan (Opsional)
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['design_by'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="md:col-span-2">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['jenis_material'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="mt-6 p-4 bg-info/10 dark:bg-info/20 rounded-lg">
                <p class="text-sm text-info-content dark:text-info-content">
                    <strong>Catatan:</strong> Unggahan Anda akan ditinjau oleh tim moderator sebelum ditampilkan di
                    galeri publik. Proses ini biasanya memakan waktu 1-2 hari kerja.
                </p>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\Users\user\Documents\WEB_HOMESPIRE\resources\views/livewire/inspiration-upload.blade.php ENDPATH**/ ?>