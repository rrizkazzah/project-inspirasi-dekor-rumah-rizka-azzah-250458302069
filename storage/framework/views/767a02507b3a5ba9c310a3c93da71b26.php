<div class="py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Stats Card -->
        <div
            class="bg-base-100 dark:bg-dark-base-100 rounded-lg shadow-md p-4 border-l-4 border-error mb-8 inline-block">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <div class="text-2xl font-bold text-base-content dark:text-dark-base-content"><?php echo e($totalLikes); ?>
        ...
        <div class="bg-base-100 dark:bg-dark-base-100 rounded-lg shadow-md mb-6 p-4">
            <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
                ...
                <div class="relative w-full md:w-96">
                    <svg class="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-base-content/50 pointer-events-none"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                    </svg>
                    <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari inspirasi..."
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $inspirations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inspiration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div
                    class="bg-base-100 dark:bg-dark-base-100 rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 group">
                    <!-- Image -->
                    <a href="<?php echo e(route('inspiration.show', $inspiration->id)); ?>"
                        class="block relative aspect-[4/3] overflow-hidden bg-base-200 dark:bg-dark-base-200">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($thumbnail): ?>
                            <img src="<?php echo e(asset('storage/' . $thumbnail)); ?>" alt="<?php echo e($inspiration->title); ?>"
                        ...
                        <div class="absolute top-2 right-2">
                            <span
                                class="px-3 py-1 bg-error text-error-content text-xs font-semibold rounded-full shadow-lg flex items-center gap-1">
                                <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4
                                    4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clip-rule="evenodd">
                                    </path>
                                </svg>
                                Disukai
                            </span>
                    ...
                    <div class="p-4">
                        <a href="<?php echo e(route('inspiration.show', $inspiration->id)); ?>">
                            <h3
                                class="font-semibold text-base-content dark:text-dark-base-content line-clamp-2 mb-2 hover:text-primary transition-colors">
                        ...
                        <div
                            ...
                            <button wire:click="unlikeInspiration(<?php echo e($inspiration->id); ?>)"
                                ...
                                <svg class="w-5 h-5 text-error group-hover/btn:scale-110 transition-transform"
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-span-full text-center py-12">
                    <svg class="mx-auto h-16 w-16 text-base-content/40 dark:text-dark-base-content/40" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12
