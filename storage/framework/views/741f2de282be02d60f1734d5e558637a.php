        ...
        <div class="container-auto">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <div x-data="{ isOpen: false }" class="relative" @click.away="isOpen = false">
                            ...
                            <div x-show="isOpen" x-transition:enter="transition ease-out duration-100"
                                ...
                                <a href="<?php echo e(route('my.favorites')); ?>"
                                    class="block px-4 py-2 text-sm text-base-content hover:bg-base-200">
                                    <span class="flex items-center gap-2">
            ...
            <nav class="flex items-center justify-between py-4">
                ...
                <ul class="hidden lg:flex items-center space-x-8 font-medium">
                    <li><a href="<?php echo e(route('home')); ?>" class="hover:text-primary">Home</a></li>
                    <li><a href="<?php echo e(route('gallery')); ?>" class="hover:text-primary">Galeri Inspirasi</a></li>
                    <li><a href="<?php echo e(route('inspiration.upload')); ?>" class="hover:text-primary">Unggah Inspirasi</a></li>
                    <li><a href="<?php echo e(route('articles.index')); ?>" class="hover:text-primary">Artikel</a></li>
                    <li><a href="<?php echo e(route('testimonials')); ?>" class="hover:text-primary">Testimoni</a></li>
                    <li><a href="<?php echo e(route('faq')); ?>" class="hover:text-primary">FAQ</a></li>
                </ul>
            ...
            <div x-show="isNavOpen" x-transition:enter="transition ease-out duration-200"
                ...
                <ul class="flex flex-col space-y-2">
                    <li><a href="<?php echo e(route('home')); ?>" class="block px-4 py-2 rounded-md hover:bg-base-200">Home</a></li>
                    <li><a href="<?php echo e(route('gallery')); ?>" class="block px-4 py-2 rounded-md hover:bg-base-200">Galeri
                            Inspirasi</a></li>
                    <li><a href="<?php echo e(route('inspiration.upload')); ?>"
                    ...
                    <li><a href="<?php echo e(route('faq')); ?>" class="block px-4 py-2 rounded-md hover:bg-base-200">FAQ</a></li>
                </ul>
            </div>
        </div>
    </header>
        ...
        <section class="py-16 lg:py-24 bg-base-200">
            <div class="container-auto">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                    ...
                    <a href="<?php echo e(route('gallery')); ?>?room=living-room" class="group block">
                    ...
                    <a href="<?php echo e(route('gallery')); ?>?room=bedroom" class="group block">
                        <div class="card overflow-hidden">
                    ...
                    <!-- Kategori 3: Dapur -->
                    <a href="<?php echo e(route('gallery')); ?>?room=kitchen" class="group block">
                        <div class="card overflow-hidden">
                    ...
                    <a href="<?php echo e(route('gallery')); ?>?room=bathroom" class="group block">
                        <div class="card overflow-hidden">
        ...
        <section class="py-16 lg:py-24 bg-base-100">
            <div class="container-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="text-left">
                    ...
                    <a href="<?php echo e(route('gallery')); ?>" class="btn btn-outline">
                        JELAJAHI SEKARANG
                    </a>
                </div>
                <div>
            ...
            <div class="container-auto">
                ...
                <?php if($testimonials->count() > 0): ?>
                        ...
                        <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-neutral-content/5 p-6 rounded-lg">
                                <div class="flex items-center mb-4">
                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        <svg class="w-5 h-5 <?php echo e($i <= $testimonial->rating ? 'text-primary' : 'text-neutral-content/30'); ?>"
                                            fill="currentColor" viewBox="0 0 20 20">
                                            <path
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <h4 class="font-medium"><?php echo e($testimonial->name); ?></h4>
                    ...
                    <div class="text-center mt-8">
                        <a href="<?php echo e(route('testimonials')); ?>" class="btn btn-outline-primary">
                ...
                <?php
                    $faqs = [
                        ...
                        [
                            ...
                            'answer' => 'Di halaman Galeri, Anda bisa menggunakan fitur pencarian berdasarkan kata kunci, filter berdasarkan ruangan (Ruang Tamu, Kamar Tidur, dll), atau filter berdasarkan gaya desain (Minimalis, Modern, Klasik, dll).'
                        ],
                        [
                ...
                <div class="max-w-3xl mx-auto space-y-4" x-data="{ openIndex: null }">
                    <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="border border-base-300 rounded-lg overflow-hidden">
                            <button @click="openIndex = openIndex === <?php echo e($index); ?> ? null : <?php echo e($index); ?>"
                                class="w-full px-6 py-4 text-left flex items-center justify-between bg-base-200/50 hover:bg-base-200 transition-colors">
                                <span class="font-medium text-base-content"><?php echo e($faq['question']); ?></span>
                                <svg class="w-5 h-5 text-base-content/60 transition-transform duration-200"
                                    :class="{ 'rotate-180': openIndex === <?php echo e($index); ?> }" fill="currentColor"
                                    viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                        clip-rule="evenodd" />
                            ...
                            <div x-show="openIndex === <?php echo e($index); ?>" x-transition:enter="transition ease-out duration-200"
                                ...
                                <p class="text-base-content/80"><?php echo e($faq['answer']); ?></p>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
        ...
        <div class="container-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="<?php echo e(route('home')); ?>" class="hover:text-primary text-neutral-content/80">Home</a>
                        </li>
                        <li><a href="<?php echo e(route('gallery')); ?>" class="hover:text-primary text-neutral-content/80">Galeri
                                Inspirasi</a></li>
                        <li><a href="<?php echo e(route('inspiration.upload')); ?>"
                    ...
                    <ul class="space-y-3">
                        ...
                        <li class="flex items-start space-x-3">
                            <svg class="w-5 h-5 shrink-0 mt-1" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91A2.25 2.25 0 012.25 6.993V6.75" />
                            </svg>
            ...
            <div class="mt-12 pt-8 border-t border-neutral-content/20 text-center text-neutral-content/60">
                <p>&copy; <?php echo e(date('Y')); ?> Homespire. All rights reserved. Platform Inspirasi Desain Interior Indonesia.
                </p>
            </div>
        </div>
    </footer>
...
<?php /**PATH C:\Users\user\Documents\WEB_HOMESPIRE\resources\views/welcome.blade.php ENDPATH**/ ?>