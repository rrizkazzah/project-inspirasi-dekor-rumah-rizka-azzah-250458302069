            ...
            <form wire:submit="submit" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="image" class="flex flex-col items-center justify-center w-full h-64 border-2 border-base-300 dark:border-dark-base-300 border-dashed rounded-lg cursor-pointer bg-base-200/50 dark:bg-dark-base-200/50 hover:bg-base-200 dark:hover:bg-dark-base-200">
                            <!--[if BLOCK]><![endif]--><?php if($image): ?>
                                <div class="relative w-full h-full">
                                    <img src="<?php echo e($image->temporaryUrl()); ?>" alt="Preview" class="w-full h-full object-cover rounded-lg">
                                </div>
                            <?php else: ?>
