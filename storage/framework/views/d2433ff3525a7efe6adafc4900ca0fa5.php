...
<head>
    ...
    <title><?php echo e(config('app.name', 'Homespire')); ?> - Inspirasi Desain Interior Indonesia</title>
    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary to-secondary relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-between p-12 text-white">
                <div>
                    <a href="<?php echo e(url('/')); ?>" class="text-4xl font-serif font-bold text-white hover:text-white/90 transition-colors">
                        Homespire
                    </a>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-8 bg-base-100">
            <div class="w-full max-w-md">
                ...
                <div class="lg:hidden text-center mb-8">
                    <a href="<?php echo e(url('/')); ?>" class="text-3xl font-serif font-bold text-secondary">
                        Homespire
                    </a>
...
<?php /**PATH C:\Users\user\Documents\WEB_HOMESPIRE\resources\views/layouts/guest.blade.php ENDPATH**/ ?>