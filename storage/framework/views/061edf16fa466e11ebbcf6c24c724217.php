                    ...
                    <div class="card-body">
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="carousel-item <?php echo e($key === 0 ? 'active' : ''); ?>">
                                        <img src="<?php echo e(asset('storage/' . $img)); ?>" class="d-block w-100"
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <div class="flex flex-wrap gap-2 mb-4">
                        <!--[if BLOCK]><![endif]--><?php if($inspiration->ruangan): ?>
                            <span
                                class="px-3 py-1 bg-indigo-100 dark:bg-indigo-900 text-indigo-800 dark:text-indigo-200 rounded-full text-sm">
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6 space-y-3">
                    ...
                    <div class="flex items-center text-sm">
                        ...
                        <span
                            class="text-gray-900 dark:text-white"><?php echo e($inspiration->created_at->format('d M Y')); ?></span>
                    </div>
                </div>

                
                <div
                    class="flex items-center gap-6 text-sm text-gray-600 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700 pt-6">
